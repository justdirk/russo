#!/usr/bin/env python3
"""Patch 007 — the new index.html (cinematic editorial redesign), delivered as gzip+base64
parts in tools/inbox/. Every part is verified line-range by sha256 against
tools/inbox/manifest.json, then the gzip and the final HTML are verified too. On any
